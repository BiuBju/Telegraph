...
public protocol ServerWebSocketDelegate: AnyObject {
  ...
  func server(_ server: Server, webSocketDidConnect webSocket: TGWebSocket, handshake: HTTPRequest)

  /// Called when a web socket disconnected
  func server(_ server: Server, webSocketDidDisconnect webSocket: TGWebSocket, error: Error?)

  /// Called when a message was received from a web socket
  func server(_ server: Server, webSocket: TGWebSocket, didReceiveMessage message: WebSocketMessage)

  /// Called when a message was sent to a web socket
  func server(_ server: Server, webSocket: TGWebSocket, didSendMessage message: WebSocketMessage)
